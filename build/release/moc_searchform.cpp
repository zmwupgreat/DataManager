...
QT_MOC_LITERAL(1, 11, 13), // "sendCondition"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 9), // "condition"
QT_MOC_LITERAL(4, 36, 10) // "onCheckbtn"

    },
    "SearchForm\0sendCondition\0\0condition\0"
    "onCheckbtn"
};
...
void SearchForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendCondition((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->onCheckbtn(); break;
        default: ;
        }
        ...
        {
            typedef void (SearchForm::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SearchForm::sendCondition)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject SearchForm::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SearchForm.data,
...
// SIGNAL 0
void SearchForm::sendCondition(QString _t1)
{
